...
Beirut at the far end of the evening. The same clay and amber on near-black.

One of four themes in **Levantine Sunset** — two places, each at two depths.
Clay and amber on a plum-leaning near-black base.

![Beirut Noir](preview.png)

## Install

```sh
omarchy theme install https://github.com/gaius-codius/omarchy-beirut-noir-theme
```

Then pick it from the theme menu, or `omarchy theme set "Beirut Noir"`.
...
![Beirut Noir wallpapers](wallpapers.jpg)
...
`~/.config/omarchy/backgrounds/beirut-noir/`.


## Boot and login screen

![Beirut Noir boot and login screen](preview-unlock.png)
...
```sh
omarchy plymouth set by theme beirut-noir
```
...
```sh
omarchy plymouth preview '#0C080C' '#F0E5D3' unlock.png /tmp/preview.png
```
...
[Batroun](https://github.com/gaius-codius/omarchy-batroun-theme) · [Batroun Noir](https://github.com/gaius-codius/omarchy-batroun-noir-theme) · [Beirut](https://github.com/gaius-codius/omarchy-beirut-theme)
